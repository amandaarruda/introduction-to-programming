...
if(poder1 < 0 or poder2 < 0):
  print("Nem faco essa comparacao! Quero ser um vingador, busco coisas maiores.")
elif(destruicao1 > destruicao2):
  print(f'Com grandes poderes, vem grandes responsabilidades. Com isso, preciso ir deter o {nome1}.')
elif(destruicao1 < destruicao2):
  print(f'Com grandes poderes, vem grandes responsabilidades. Com isso, preciso ir deter o {nome2}.')
else:
  if (destruicao1 % 2 == 0):
